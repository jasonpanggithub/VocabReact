      ...
      <div className="similar-page__toolbar">
        <div className="form-check form-check-inline">
          <input
            ...
            type="radio"
            name="similar-pronunciation-source"
            id="similar-pronunciation-source-calendar"
            value="calendar"
          ...
          />
          <label className="form-check-label" htmlFor="similar-pronunciation-source-calendar">
            Calendar
          </label>
        </div>
        <div className="form-check form-check-inline">
          <input
            ...
            type="radio"
            name="similar-pronunciation-source"
            id="similar-pronunciation-source-failed"
            value="failed"
          ...
          />
          <label className="form-check-label" htmlFor="similar-pronunciation-source-failed">
            By Failed
          </label>
        </div>
        <div className="form-check form-check-inline">
          <input
            ...
            type="radio"
            name="similar-pronunciation-source"
            id="similar-pronunciation-source-tnplus"
            value="tnplus"
          ...
          />
          <label className="form-check-label" htmlFor="similar-pronunciation-source-tnplus">
            By TN+
          </label>
        </div>
      </div>
